...
public class MyPageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Edge-to-Edge 디스플레이 처리
        View mainView = findViewById(R.id.scroll_view_my_page);
        ...
        tvMyPosts.setOnClickListener(v -> Toast.makeText(this, "내가 쓴 글 보기", Toast.LENGTH_SHORT).show());
        tvFriendManagement.setOnClickListener(v -> Toast.makeText(this, "친구 관리 기능", Toast.LENGTH_SHORT).show());
